 ...
 * §"TDD ADAPTATION"). Replaces [TddAdapter], which deviates from that design in four load-bearing
 * ways, each measured on this user's own 60 days:
 *
 ...
 *     defect and it is what actually drove the drift. [TddAdapter] cuts a flat x0.90 whenever
